  ...
  const products = [
    {
      ...
      description: 'Premium leather western saddle crafted for comfort and durability',
      image: 'p1.webp',
      rating: 5,
      featured: true
    },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Discover our exceptional collection of handcrafted saddles and equestrian gear,
            each piece designed with meticulous attention to detail and superior craftsmanship.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product, index) => (
            <div
              key={product.id}
              className={`group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
                }`}
        ...
        {/* Call to Action */}
        <div className={`text-center mt-16 transition-all duration-1000 delay-600 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
          }`}>
