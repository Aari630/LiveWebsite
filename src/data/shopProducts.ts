...
export const shopProducts: Product[] = [
  ...
  },
  {
    ...
    image: "w2.webp",
    description:
      "Horse Saddle Western Handmade Beautifully Show Saddle – Crafted with Sterling Silver Metals, Cow Suede Seat, Intricate Carved Leather Design, and Premium Genuine Real Leather Construction",
    category: "Western Saddles",
    amazonLink:
  ...
  },
  {
    ...
    image: "w3.webp",
    description:
      "Full Carved Flower Tooled Western Saddle with Padded Seat – Premium Real Leather Handcrafted, Carved & Tooled for Barrel Racing, Pleasure Riding, and Training Avaikable",
    category: "Western Saddles",
    amazonLink:
